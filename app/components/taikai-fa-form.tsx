    ...
    <div className="mt-5 max-w-4xl mx-auto text-ink">
      <div className="rounded-lg p-6 bg-panel border border-solid border-pnkf-gold">
        ...
        <p className="text-sm mb-4 text-ink-dim">
          Don't have a team? No problem! You may still enter the taikai as a
          free agent and we will prioritize filling in empty spots in existing
          teams or create a new team of free agents for you. If you have another
          free agent that you would like to participate with, please indicate
          their name on the form and we will do our best to put you on the same
          team.
        </p>
